...
│   ├── bases/                  # CRD YAML files (single source of truth)
│   ├── kustomization.yaml
│   └── kustomizeconfig.yaml
├── manager/                    # Controller manager deployment
│   ├── kustomization.yaml
│   ├── manager.yaml            # Namespace + Deployment combined
│   └── serviceaccount.yaml
...
│   ├── role.yaml
│   ├── rolebinding.yaml
│   ├── mutatingwebhookconfiguration.yaml   # Custom webhook config (used by kustomize)
│   ├── validatingwebhookconfiguration.yaml # Custom webhook config (used by kustomize)
│   └── manifests.yaml          # Auto-generated by controller-gen (CI only, not used)
...
│   ├── role.yaml               # Auto-generated by controller-gen (CI only, not used)
│   ├── rolebinding.yaml
│   ├── spark_serviceaccount.yaml
│   ├── spark_role.yaml
│   ├── spark_rolebinding.yaml
│   └── *_viewer_role.yaml / *_editor_role.yaml
├── default/                    # Main entry point (development/standalone)
│   └── kustomization.yaml
...
├── namespace.yaml                          # Creates spark-operator namespace (usually not needed)
├── rbac.yaml                               # Custom spark-driver SA with extended permissions
├── validating-admission-policy.yaml        # Rejects fsGroup in SparkApplications
