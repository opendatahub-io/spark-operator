...
#
# Note: When running via 'make openshift-test-setup', the Makefile adds bin/ to PATH
...
DOCLING_NAMESPACE="docling-spark" # Namespace for Docling Spark
...
if ! command -v kind &>/dev/null; then
    ...
    echo "   Run 'make kind' first, or use 'make openshift-test-setup' which sets up PATH automatically."
    exit 1
fi
...
# =================================================
log "Creating namespace: $DOCLING_NAMESPACE"
kubectl create namespace "$DOCLING_NAMESPACE" --dry-run=client -o yaml | kubectl apply -f -
...
# =================================================
log "Applying RBAC..."
kubectl apply -f "$REPO_ROOT/examples/openshift/k8s/base/rbac.yaml"
pass "RBAC applied"

# =================================================
# Step 5 (Optional): Load docling-spark image
# =================================================
...
# =================================================
# Step 6 (Optional): Upload test assets
# =================================================
...
echo "Namespace: $DOCLING_NAMESPACE"
echo "Kubeconfig: $KIND_KUBE_CONFIG"
echo ""
echo "Next steps:"
echo "  1. Run shell tests:   ./examples/openshift/tests/test-operator-install.sh"
echo "                        ./examples/openshift/tests/test-spark-pi.sh"
echo ""
echo "  2. Or run Go tests:   go test -tags=openshift ./examples/openshift/tests/ -v -ginkgo.v -timeout 30m"
echo ""
echo "  3. Cleanup when done: make openshift-test-cleanup"
echo ""