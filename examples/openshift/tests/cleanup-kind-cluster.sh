...
kubectl delete namespace docling-spark --ignore-not-found --wait=false 2>/dev/null || true
kubectl delete namespace spark-operator-openshift --ignore-not-found --wait=false 2>/dev/null || true
